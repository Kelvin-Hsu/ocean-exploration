...
\label{Section:LinearisedEntropy}
	...
	\subsubsection{Scott Reef}
		...
		\label{Figure:Results:ScottReefPredictionInformationEntropyNatural}
		\end{figure}
		
		\begin{figure}[!htbp]
		\centering
			\includegraphics[width = \linewidth]{Figures/scott_reef_modeling/Figure9.png}
		\caption{Scott Reef: Prediction Information Entropy (Adjusted colour scale)}
		...
		\caption{Scott Reef: Linearised Differential Entropy (Adjusted colour scale)}
