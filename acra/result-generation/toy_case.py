...
def main():
    ...
    fig.tight_layout()
    if y_unique.shape[0] > 2:
    	fig.savefig('../Figures/multiclass.eps')
    else:
    	fig.savefig('../Figures/binary.eps')
    return
    ...
    if SAVE_OUTPUTS:
        ...
        gp.classifier.utils.save_all_figures(full_directory, axis_equal = True, extension = 'eps', rcparams = rcparams)
