...
\addtocontents{toc}{\vspace{0em}}  % Add a gap in the Contents, for aesthetics
%
I am deeply grateful to my supervisors Stefan Williams and Simon O'Callaghan for advising and helping me throughout this thesis project. To Stef, thank you for taking your time to answer my loads of questions everytime despite your busy schedule. Thank you for being easy going and easy to talk to despite my never ending pester to meet! To Simon, thank you for being so approachable when talking about things both inside and outside of work. You always listen to what I have to say patiently, and always manage to give me suggestions for improvement in a very nice way. Thank you for patiently thinking through problems and saying `hm, that's interesting alright' with me everytime I discover something weird that I did not understand. You made it easy for me to share my ideas without fearing sounding stupid. In short, thank you for your awesomeness.

I would also like to thank the people I worked with at NICTA, who made the working environment fun and enjoyable. They were always understanding when I needed help and I have always felt supported throughout the year. To Alistair, I admire your clear thinking and explanations whenever I have a mental block about a very specific concept. You always seem to understand what I am trying to ask even when I myself have trouble identifying my confusion. Many of the ideas written in this thesis were built upon the things you pointed out or the things you've suggested me to try during those discussions. Thank you for your brilliant suggestions! To Dan, thank you for your thoughtful advices and suggestions throughout the year. You were always quick to point out what I can look into, especially when I didn't realise I needed them. Thank you for stepping me through some of the difficult concepts in the beginning and even patiently helping me hunt those frustrating bugs when things were not working so well. To Lachlan, thank you for all the advices throughout the year. I still remember your detailed explanation about Bayesian inference and the almost philosophical note about extending deterministic logic to probability theory during the summer. That was very cool to listen to.

%Finally, I would like to thank my friends and family for being the supportive bunch they always have been. From all the silly chats, stress inspired rants (probably first place in frequency this year), mutual mocking, to the understanding support and encouragement. 
...
\listofnomenclature{ll}  % Include a list of Symbols (a three column table)
{
	...
	$\tilde{\bvec{p}}^{\star}$ & Estimated Joint Probability Vector at Query Points \\
