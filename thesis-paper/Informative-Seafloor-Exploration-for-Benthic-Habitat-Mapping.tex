...
\textit{``Amongst a group of three people, there is always one person I can learn from.''}
\begin{flushright}
	{\CJKfamily{bkai}孔子} \\
	Confucius
\end{flushright}
...
\listofnotations{llrcl}  % Include a list of Physical Constants (a four column table)
{
	...
	% $\{x_{i}\}_{i \in I}$ & = & $\begin{bmatrix} x_{1} & x_{2} & \dots \end{bmatrix}$
