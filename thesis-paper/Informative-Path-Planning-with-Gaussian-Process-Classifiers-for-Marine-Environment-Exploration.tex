...
\title  {Honours Thesis \\ \textnormal{Informative Path Planning with Gaussian Process Classifiers for Marine Environment Exploration}}
...
I, Yuan-Shuo Kelvin Hsu, declare that this thesis titled, `Active Path Planning of Autonomous Underwater Vehicles for Ocean Terrain Exploration' and the work presented in it are my own. I confirm that:
...
\input{Chapters/Building-Gaussian-Process-Classifiers}

\input{Chapters/Modeling-the-Ocean-Environment}

\input{Chapters/Receding-Horizon-Approach-to-Informative-Path-Planning}
