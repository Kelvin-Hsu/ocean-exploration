	...
	\label{InformativeSeafloorExploration:MCPIE}
		...
		\label{InformativeSeafloorExploration:MCPIE:Multiclass}
			...
			\label{InformativeSeafloorExploration:MCPIE:Multiclass:OVA}
				...
				Analogous to \eqref{Equation:PredictiveLatentBinaryGP}, there are $n_{C}$ latent functions $\{f^{1}(x), f^{2}(x), \dots, f^{n_{C}}(x)\}$ corresponding to each class \eqref{Equation:PredictiveLatentMulticlassOVA} for a multiclass scenario with $n_{C}$ classes. \begin{equation}
...
%				{Cumulative Sum};
	...
	\label{InformativeSeafloorExploration:ScottReef}
		...
		\label{InformativeSeafloorExploration:ScottReef:SingleMission}
			...
			\begin{figure}[!htbp]
			\centering
			  \subfigure[Prediction Information Entropy]{\label{Figure:ScottReefPredictionInformationEntropy} \includegraphics[width = 0.48\linewidth]{Figures/scott_reef_mapping/Figure9.eps}}
			  \subfigure[Linearised Model Differential Entropy]{\label{Figure:ScottReefLinearisedModelDifferentialEntropy}	\includegraphics[width = 0.48\linewidth]{Figures//scott_reef_mapping/Figure11.eps}}
