...
%			\end{figure}
		...
		\subsection{Serial Mission Planning for Seafloor Exploration}
			...
			\begin{figure}[!htbp]
			\centering
			  \subfigure[LMDE Acquisition]{\label{Figure:SerialOptimalPaths:LMDE} 
			  	\includegraphics[width = 0.32\linewidth]{Figures/informative_seafloor_exploration/serial_lmde/mie_propose1.eps}
			  	\includegraphics[width = 0.32\linewidth]{Figures/informative_seafloor_exploration/serial_lmde/mie_propose100.eps}
			  	\includegraphics[width = 0.32\linewidth]{Figures/informative_seafloor_exploration/serial_lmde/mie_propose200.eps}}
			  \subfigure[MCPIE Acquisition]{\label{Figure:SerialOptimalPaths:MCPIE}	
			  	\includegraphics[width = 0.32\linewidth]{Figures/informative_seafloor_exploration/serial_mcpie/mie_propose1.eps}
			  	\includegraphics[width = 0.32\linewidth]{Figures/informative_seafloor_exploration/serial_mcpie/mie_propose100.eps}
			  	\includegraphics[width = 0.32\linewidth]{Figures/informative_seafloor_exploration/serial_mcpie/mie_propose200.eps}}
			\caption{Scott Reef: Exploration paths}
			\label{Figure:SerialOptimalPaths}
			\end{figure}
