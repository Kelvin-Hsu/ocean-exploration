...
\title  {Honours Thesis \\ \textnormal{Informative Path Planning with Gaussian Process Classifiers for Autonomous Ocean Environment Exploration}}
...
\input{Chapters/Chapter3} % Modeling the Ocean Environment 

\input{Chapters/Chapter4} % Receding Horizon Approach to Informative Path Planning
...
\input{Appendices/AppendixA} % Computational Aspects of Gaussian Processes
\input{Appendices/AppendixB} % Other Approximations for Gaussian Process Classification
