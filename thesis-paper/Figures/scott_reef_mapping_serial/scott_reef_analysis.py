...
def main():
    ...
    sea.vis.scatter(
        ...
        **map_kwargs)
    sea.vis.describe_plot(
        title = '(b) Prediction Map [Miss Ratio: {0:.2f}\%]'.format(100 * miss_ratio), 
        xlabel = 'x [Eastings (km)]', ylabel = 'y [Northings (km)]', 
        clabel = 'Habitat Labels', cticks = y_unique, cticklabels = y_names,
        vis_range = vis_range, aspect_equal = True, 
        fontsize = FONTSIZE, fontname = FONTNAME, ticksize = TICKSIZE, 
    ...
    sea.vis.scatter(
        ...
        **map_kwargs)
    sea.vis.describe_plot(title = '(c) Prediction Information Entropy', 
        xlabel = 'x [Eastings (km)]', ylabel = 'y [Northings (km)]', 
    ...
    sea.vis.scatter(
        ...
        **map_kwargs)
    sea.vis.describe_plot(title = '(d) Linearised Model Differential Entropy', 
        xlabel = 'x [Eastings (km)]', ylabel = 'y [Northings (km)]', 
